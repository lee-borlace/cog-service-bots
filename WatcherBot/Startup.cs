...
namespace WatcherBot
{
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var botConfig = BotConfiguration.Load(botFilePath ?? @".\WatcherBot.bot", secretKey);
            ...
            services.AddBot<WatcherBotBot>(options =>
            {
                ...
                ILogger logger = _loggerFactory.CreateLogger<WatcherBotBot>();
            ...
            services.AddSingleton<WatcherBotAccessors>(sp =>
            {
                var accessors = new WatcherBotAccessors(conversationState, userState)
                {
                    WatcherBotState = conversationState.CreateProperty<WatcherBotState>(WatcherBotAccessors.WatcherBotStateName),
                    DialogState = conversationState.CreateProperty<DialogState>(WatcherBotAccessors.DialogStateName),
                };
        ...
        private static IStorage GetBlobDataStore(BotConfiguration botConfig)
        {
            ...
            const string DefaultBotContainer = "bot-state-watcherbot";
